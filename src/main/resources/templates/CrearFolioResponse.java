...
@XmlType(name = "CrearFolioResponse", namespace = "", propOrder = {
    "controlData",
    "detailResponse",
    "crearFolioResponse"
})
public class CrearFolioResponse {
    ...
    @XmlElement(name = "detailResponse", namespace = "http://amx.com/mexico/telcel/esb/v1_2", required = true)
    protected DetailResponseType detailResponse;
    //@XmlElement(namespace = "", required = true)
    @XmlElement(name = "crearFolioResponse", namespace = "http://www.amx.com.mx/mexico/telcel/di/sds/gsa/dgpsti/esb/sipabservice", required = true)
