...
public class CrearFolioRespType {
    ...
    @XmlElement(name = "idReps", namespace = "http://amx.com/mexico/telcel/esb/v1_2", required = true)
    //@XmlElement(namespace = "", required = true)
    protected String idResp;
    @XmlElement(name = "descResp", namespace = "http://www.amx.com.mx/mexico/telcel/di/sds/gsa/dgpsti/esb/sipabservice", required = true)
    //@XmlElement(namespace = "", required = true)
    protected String descResp;
    @XmlElement(name = "idFolio", namespace = "http://www.amx.com.mx/mexico/telcel/di/sds/gsa/dgpsti/esb/sipabservice")
